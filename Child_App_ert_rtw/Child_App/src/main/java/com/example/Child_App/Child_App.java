...
import com.example.Child_App.databinding.ActivityMainBinding;
...
public class Child_App extends AppCompatActivity implements OnFragmentInteractionListener , SensorEventListener, CvCameraViewListener2 {
 ...
 // properties specific for Camera block
   ...
   private boolean isCamera2Supported() {
    ...
    {
        return true && isCameraPermissionGranted && isAudioRecordPermissionGranted && isFineLocationPermissionGranted;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        com.example.Child_App.databinding.ActivityMainBinding activityMainBinding = ActivityMainBinding.inflate(LayoutInflater.from(this));
...
mSendBlockNames = getResources().getStringArray(R.array.tcpSendBlockNames);
    ...
    private Child_App thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","Child_App"};
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (!checkIfAllPermissionsGranted() && !isCameraPermissionRequested && !isAudioRecordPermissionRequested && !isFineLocationPermissionRequested) {
            requestPermission();
        }
    }
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("Child_App.updateTextViewById", ex.getLocalizedMessage());
                }
            }
        });
    }
...
public void audioFileReadTerminate(int idx) {
    ...
    private native int naMain(String[] argv, Child_App pThis);
