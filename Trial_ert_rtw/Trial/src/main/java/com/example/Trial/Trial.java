...
public class Trial extends AppCompatActivity implements OnFragmentInteractionListener , SensorEventListener, CvCameraViewListener2 {
 ...
 // properties specific for Camera block
   ...
   private boolean isCamera2Supported() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        com.example.Trial.databinding.ActivityMainBinding activityMainBinding = ActivityMainBinding.inflate(LayoutInflater.from(this));
...
mSendBlockNames = getResources().getStringArray(R.array.tcpSendBlockNames);
    ...
    private Trial thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","Trial"};
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("Trial.updateTextViewById", ex.getLocalizedMessage());
                }
            }
        });
    }
...
public void audioFileReadTerminate(int idx) {
    ...
    private native int naMain(String[] argv, Trial pThis);
