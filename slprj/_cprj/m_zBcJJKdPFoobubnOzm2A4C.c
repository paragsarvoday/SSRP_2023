...
static void cgxe_mdl_start(InstanceStruct_zBcJJKdPFoobubnOzm2A4C *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_zBcJJKdPFoobubnOzm2A4C
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_zBcJJKdPFoobubnOzm2A4C
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_zBcJJKdPFoobubnOzm2A4C
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_zBcJJKdPFoobubnOzm2A4C
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_zBcJJKdPFoobubnOzm2A4C
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_zBcJJKdPFoobubnOzm2A4C
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_zBcJJKdPFoobubnOzm2A4C
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_zBcJJKdPFoobubnOzm2A4C
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_zBcJJKdPFoobubnOzm2A4C
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_zBcJJKdPFoobubnOzm2A4C
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_zBcJJKdPFoobubnOzm2A4C *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_zBcJJKdPFoobubnOzm2A4C
...
static void cgxe_mdl_set_sim_state(InstanceStruct_zBcJJKdPFoobubnOzm2A4C
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_zBcJJKdPFoobubnOzm2A4C
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_zBcJJKdPFoobubnOzm2A4C(SimStruct *S, int_T tid)
{
  InstanceStruct_zBcJJKdPFoobubnOzm2A4C *moduleInstance =
    (InstanceStruct_zBcJJKdPFoobubnOzm2A4C *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_zBcJJKdPFoobubnOzm2A4C(SimStruct *S)
{
  InstanceStruct_zBcJJKdPFoobubnOzm2A4C *moduleInstance =
    (InstanceStruct_zBcJJKdPFoobubnOzm2A4C *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_zBcJJKdPFoobubnOzm2A4C(SimStruct *S, int_T tid)
{
  InstanceStruct_zBcJJKdPFoobubnOzm2A4C *moduleInstance =
    (InstanceStruct_zBcJJKdPFoobubnOzm2A4C *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_zBcJJKdPFoobubnOzm2A4C(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_zBcJJKdPFoobubnOzm2A4C *moduleInstance =
    (InstanceStruct_zBcJJKdPFoobubnOzm2A4C *)cgxertGetRuntimeInstance(S);
...
static void setSimState_zBcJJKdPFoobubnOzm2A4C(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_zBcJJKdPFoobubnOzm2A4C *moduleInstance =
    (InstanceStruct_zBcJJKdPFoobubnOzm2A4C *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_zBcJJKdPFoobubnOzm2A4C(SimStruct *S)
{
  InstanceStruct_zBcJJKdPFoobubnOzm2A4C *moduleInstance =
    (InstanceStruct_zBcJJKdPFoobubnOzm2A4C *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_zBcJJKdPFoobubnOzm2A4C(SimStruct *S)
{
  InstanceStruct_zBcJJKdPFoobubnOzm2A4C *moduleInstance =
    (InstanceStruct_zBcJJKdPFoobubnOzm2A4C *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_zBcJJKdPFoobubnOzm2A4C(SimStruct *S)
{
  InstanceStruct_zBcJJKdPFoobubnOzm2A4C *moduleInstance =
    (InstanceStruct_zBcJJKdPFoobubnOzm2A4C *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_zBcJJKdPFoobubnOzm2A4C(SimStruct *S)
{
  InstanceStruct_zBcJJKdPFoobubnOzm2A4C *moduleInstance =
    (InstanceStruct_zBcJJKdPFoobubnOzm2A4C *)calloc(1, sizeof
    (InstanceStruct_zBcJJKdPFoobubnOzm2A4C));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_zBcJJKdPFoobubnOzm2A4C);
  ssSetmdlInitializeConditions(S, mdlInitialize_zBcJJKdPFoobubnOzm2A4C);
  ssSetmdlUpdate(S, mdlUpdate_zBcJJKdPFoobubnOzm2A4C);
  ssSetmdlTerminate(S, mdlTerminate_zBcJJKdPFoobubnOzm2A4C);
  ssSetmdlEnable(S, mdlEnable_zBcJJKdPFoobubnOzm2A4C);
  ssSetmdlDisable(S, mdlDisable_zBcJJKdPFoobubnOzm2A4C);
...
static void mdlProcessParameters_zBcJJKdPFoobubnOzm2A4C(SimStruct *S)
{
}

void method_dispatcher_zBcJJKdPFoobubnOzm2A4C(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_zBcJJKdPFoobubnOzm2A4C(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_zBcJJKdPFoobubnOzm2A4C(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_zBcJJKdPFoobubnOzm2A4C(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_zBcJJKdPFoobubnOzm2A4C(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: zBcJJKdPFoobubnOzm2A4C.\n"
...
mxArray *cgxe_zBcJJKdPFoobubnOzm2A4C_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_zBcJJKdPFoobubnOzm2A4C_fallback_info(void)
{
