...
static void cgxe_mdl_start(InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC
...
static void cgxe_mdl_set_sim_state(InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_KDwHGQ2xXp4wmWKPmnDGqC(SimStruct *S, int_T tid)
{
  InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *moduleInstance =
    (InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_KDwHGQ2xXp4wmWKPmnDGqC(SimStruct *S)
{
  InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *moduleInstance =
    (InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_KDwHGQ2xXp4wmWKPmnDGqC(SimStruct *S, int_T tid)
{
  InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *moduleInstance =
    (InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_KDwHGQ2xXp4wmWKPmnDGqC(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *moduleInstance =
    (InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *)cgxertGetRuntimeInstance(S);
...
static void setSimState_KDwHGQ2xXp4wmWKPmnDGqC(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *moduleInstance =
    (InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_KDwHGQ2xXp4wmWKPmnDGqC(SimStruct *S)
{
  InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *moduleInstance =
    (InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_KDwHGQ2xXp4wmWKPmnDGqC(SimStruct *S)
{
  InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *moduleInstance =
    (InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_KDwHGQ2xXp4wmWKPmnDGqC(SimStruct *S)
{
  InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *moduleInstance =
    (InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_KDwHGQ2xXp4wmWKPmnDGqC(SimStruct *S)
{
  InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *moduleInstance =
    (InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC *)calloc(1, sizeof
    (InstanceStruct_KDwHGQ2xXp4wmWKPmnDGqC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_KDwHGQ2xXp4wmWKPmnDGqC);
  ssSetmdlInitializeConditions(S, mdlInitialize_KDwHGQ2xXp4wmWKPmnDGqC);
  ssSetmdlUpdate(S, mdlUpdate_KDwHGQ2xXp4wmWKPmnDGqC);
  ssSetmdlTerminate(S, mdlTerminate_KDwHGQ2xXp4wmWKPmnDGqC);
  ssSetmdlEnable(S, mdlEnable_KDwHGQ2xXp4wmWKPmnDGqC);
  ssSetmdlDisable(S, mdlDisable_KDwHGQ2xXp4wmWKPmnDGqC);
...
static void mdlProcessParameters_KDwHGQ2xXp4wmWKPmnDGqC(SimStruct *S)
{
}

void method_dispatcher_KDwHGQ2xXp4wmWKPmnDGqC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_KDwHGQ2xXp4wmWKPmnDGqC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_KDwHGQ2xXp4wmWKPmnDGqC(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_KDwHGQ2xXp4wmWKPmnDGqC(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_KDwHGQ2xXp4wmWKPmnDGqC(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: KDwHGQ2xXp4wmWKPmnDGqC.\n"
...
mxArray *cgxe_KDwHGQ2xXp4wmWKPmnDGqC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_KDwHGQ2xXp4wmWKPmnDGqC_fallback_info(void)
{
