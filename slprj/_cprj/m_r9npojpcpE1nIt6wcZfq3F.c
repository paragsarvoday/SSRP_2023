...
static void cgxe_mdl_start(InstanceStruct_r9npojpcpE1nIt6wcZfq3F *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_r9npojpcpE1nIt6wcZfq3F
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_r9npojpcpE1nIt6wcZfq3F
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_r9npojpcpE1nIt6wcZfq3F
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_r9npojpcpE1nIt6wcZfq3F
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_r9npojpcpE1nIt6wcZfq3F
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_r9npojpcpE1nIt6wcZfq3F
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_r9npojpcpE1nIt6wcZfq3F
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_r9npojpcpE1nIt6wcZfq3F
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_r9npojpcpE1nIt6wcZfq3F
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_r9npojpcpE1nIt6wcZfq3F
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_r9npojpcpE1nIt6wcZfq3F *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_r9npojpcpE1nIt6wcZfq3F
...
static void cgxe_mdl_set_sim_state(InstanceStruct_r9npojpcpE1nIt6wcZfq3F
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_r9npojpcpE1nIt6wcZfq3F
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_r9npojpcpE1nIt6wcZfq3F(SimStruct *S, int_T tid)
{
  InstanceStruct_r9npojpcpE1nIt6wcZfq3F *moduleInstance =
    (InstanceStruct_r9npojpcpE1nIt6wcZfq3F *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_r9npojpcpE1nIt6wcZfq3F(SimStruct *S)
{
  InstanceStruct_r9npojpcpE1nIt6wcZfq3F *moduleInstance =
    (InstanceStruct_r9npojpcpE1nIt6wcZfq3F *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_r9npojpcpE1nIt6wcZfq3F(SimStruct *S, int_T tid)
{
  InstanceStruct_r9npojpcpE1nIt6wcZfq3F *moduleInstance =
    (InstanceStruct_r9npojpcpE1nIt6wcZfq3F *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_r9npojpcpE1nIt6wcZfq3F(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_r9npojpcpE1nIt6wcZfq3F *moduleInstance =
    (InstanceStruct_r9npojpcpE1nIt6wcZfq3F *)cgxertGetRuntimeInstance(S);
...
static void setSimState_r9npojpcpE1nIt6wcZfq3F(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_r9npojpcpE1nIt6wcZfq3F *moduleInstance =
    (InstanceStruct_r9npojpcpE1nIt6wcZfq3F *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_r9npojpcpE1nIt6wcZfq3F(SimStruct *S)
{
  InstanceStruct_r9npojpcpE1nIt6wcZfq3F *moduleInstance =
    (InstanceStruct_r9npojpcpE1nIt6wcZfq3F *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_r9npojpcpE1nIt6wcZfq3F(SimStruct *S)
{
  InstanceStruct_r9npojpcpE1nIt6wcZfq3F *moduleInstance =
    (InstanceStruct_r9npojpcpE1nIt6wcZfq3F *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_r9npojpcpE1nIt6wcZfq3F(SimStruct *S)
{
  InstanceStruct_r9npojpcpE1nIt6wcZfq3F *moduleInstance =
    (InstanceStruct_r9npojpcpE1nIt6wcZfq3F *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_r9npojpcpE1nIt6wcZfq3F(SimStruct *S)
{
  InstanceStruct_r9npojpcpE1nIt6wcZfq3F *moduleInstance =
    (InstanceStruct_r9npojpcpE1nIt6wcZfq3F *)calloc(1, sizeof
    (InstanceStruct_r9npojpcpE1nIt6wcZfq3F));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_r9npojpcpE1nIt6wcZfq3F);
  ssSetmdlInitializeConditions(S, mdlInitialize_r9npojpcpE1nIt6wcZfq3F);
  ssSetmdlUpdate(S, mdlUpdate_r9npojpcpE1nIt6wcZfq3F);
  ssSetmdlTerminate(S, mdlTerminate_r9npojpcpE1nIt6wcZfq3F);
  ssSetmdlEnable(S, mdlEnable_r9npojpcpE1nIt6wcZfq3F);
  ssSetmdlDisable(S, mdlDisable_r9npojpcpE1nIt6wcZfq3F);
...
static void mdlProcessParameters_r9npojpcpE1nIt6wcZfq3F(SimStruct *S)
{
}

void method_dispatcher_r9npojpcpE1nIt6wcZfq3F(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_r9npojpcpE1nIt6wcZfq3F(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_r9npojpcpE1nIt6wcZfq3F(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_r9npojpcpE1nIt6wcZfq3F(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_r9npojpcpE1nIt6wcZfq3F(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: r9npojpcpE1nIt6wcZfq3F.\n"
...
mxArray *cgxe_r9npojpcpE1nIt6wcZfq3F_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_r9npojpcpE1nIt6wcZfq3F_fallback_info(void)
{
