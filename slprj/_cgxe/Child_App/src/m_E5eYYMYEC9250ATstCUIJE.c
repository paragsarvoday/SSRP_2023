...
static void cgxe_mdl_start(InstanceStruct_E5eYYMYEC9250ATstCUIJE *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_E5eYYMYEC9250ATstCUIJE
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_E5eYYMYEC9250ATstCUIJE
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_E5eYYMYEC9250ATstCUIJE
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_E5eYYMYEC9250ATstCUIJE
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_E5eYYMYEC9250ATstCUIJE
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_E5eYYMYEC9250ATstCUIJE
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_E5eYYMYEC9250ATstCUIJE
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_E5eYYMYEC9250ATstCUIJE
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_E5eYYMYEC9250ATstCUIJE
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_E5eYYMYEC9250ATstCUIJE
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_E5eYYMYEC9250ATstCUIJE *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_E5eYYMYEC9250ATstCUIJE
...
static void cgxe_mdl_set_sim_state(InstanceStruct_E5eYYMYEC9250ATstCUIJE
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_E5eYYMYEC9250ATstCUIJE
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_E5eYYMYEC9250ATstCUIJE(SimStruct *S, int_T tid)
{
  InstanceStruct_E5eYYMYEC9250ATstCUIJE *moduleInstance =
    (InstanceStruct_E5eYYMYEC9250ATstCUIJE *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_E5eYYMYEC9250ATstCUIJE(SimStruct *S)
{
  InstanceStruct_E5eYYMYEC9250ATstCUIJE *moduleInstance =
    (InstanceStruct_E5eYYMYEC9250ATstCUIJE *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_E5eYYMYEC9250ATstCUIJE(SimStruct *S, int_T tid)
{
  InstanceStruct_E5eYYMYEC9250ATstCUIJE *moduleInstance =
    (InstanceStruct_E5eYYMYEC9250ATstCUIJE *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_E5eYYMYEC9250ATstCUIJE(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_E5eYYMYEC9250ATstCUIJE *moduleInstance =
    (InstanceStruct_E5eYYMYEC9250ATstCUIJE *)cgxertGetRuntimeInstance(S);
...
static void setSimState_E5eYYMYEC9250ATstCUIJE(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_E5eYYMYEC9250ATstCUIJE *moduleInstance =
    (InstanceStruct_E5eYYMYEC9250ATstCUIJE *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_E5eYYMYEC9250ATstCUIJE(SimStruct *S)
{
  InstanceStruct_E5eYYMYEC9250ATstCUIJE *moduleInstance =
    (InstanceStruct_E5eYYMYEC9250ATstCUIJE *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_E5eYYMYEC9250ATstCUIJE(SimStruct *S)
{
  InstanceStruct_E5eYYMYEC9250ATstCUIJE *moduleInstance =
    (InstanceStruct_E5eYYMYEC9250ATstCUIJE *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_E5eYYMYEC9250ATstCUIJE(SimStruct *S)
{
  InstanceStruct_E5eYYMYEC9250ATstCUIJE *moduleInstance =
    (InstanceStruct_E5eYYMYEC9250ATstCUIJE *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_E5eYYMYEC9250ATstCUIJE(SimStruct *S)
{
  InstanceStruct_E5eYYMYEC9250ATstCUIJE *moduleInstance =
    (InstanceStruct_E5eYYMYEC9250ATstCUIJE *)calloc(1, sizeof
    (InstanceStruct_E5eYYMYEC9250ATstCUIJE));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_E5eYYMYEC9250ATstCUIJE);
  ssSetmdlInitializeConditions(S, mdlInitialize_E5eYYMYEC9250ATstCUIJE);
  ssSetmdlUpdate(S, mdlUpdate_E5eYYMYEC9250ATstCUIJE);
  ssSetmdlTerminate(S, mdlTerminate_E5eYYMYEC9250ATstCUIJE);
  ssSetmdlEnable(S, mdlEnable_E5eYYMYEC9250ATstCUIJE);
  ssSetmdlDisable(S, mdlDisable_E5eYYMYEC9250ATstCUIJE);
...
static void mdlProcessParameters_E5eYYMYEC9250ATstCUIJE(SimStruct *S)
{
}

void method_dispatcher_E5eYYMYEC9250ATstCUIJE(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_E5eYYMYEC9250ATstCUIJE(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_E5eYYMYEC9250ATstCUIJE(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_E5eYYMYEC9250ATstCUIJE(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_E5eYYMYEC9250ATstCUIJE(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: E5eYYMYEC9250ATstCUIJE.\n"
...
mxArray *cgxe_E5eYYMYEC9250ATstCUIJE_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_E5eYYMYEC9250ATstCUIJE_fallback_info(void)
{
