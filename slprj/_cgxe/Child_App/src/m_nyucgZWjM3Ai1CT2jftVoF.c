...
static void cgxe_mdl_start(InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_nyucgZWjM3Ai1CT2jftVoF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_nyucgZWjM3Ai1CT2jftVoF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_nyucgZWjM3Ai1CT2jftVoF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_nyucgZWjM3Ai1CT2jftVoF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_nyucgZWjM3Ai1CT2jftVoF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_nyucgZWjM3Ai1CT2jftVoF
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_nyucgZWjM3Ai1CT2jftVoF
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_nyucgZWjM3Ai1CT2jftVoF
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_nyucgZWjM3Ai1CT2jftVoF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_nyucgZWjM3Ai1CT2jftVoF
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_nyucgZWjM3Ai1CT2jftVoF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_nyucgZWjM3Ai1CT2jftVoF
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_nyucgZWjM3Ai1CT2jftVoF
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_nyucgZWjM3Ai1CT2jftVoF(SimStruct *S, int_T tid)
{
  InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *moduleInstance =
    (InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_nyucgZWjM3Ai1CT2jftVoF(SimStruct *S)
{
  InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *moduleInstance =
    (InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_nyucgZWjM3Ai1CT2jftVoF(SimStruct *S, int_T tid)
{
  InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *moduleInstance =
    (InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_nyucgZWjM3Ai1CT2jftVoF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *moduleInstance =
    (InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_nyucgZWjM3Ai1CT2jftVoF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *moduleInstance =
    (InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_nyucgZWjM3Ai1CT2jftVoF(SimStruct *S)
{
  InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *moduleInstance =
    (InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_nyucgZWjM3Ai1CT2jftVoF(SimStruct *S)
{
  InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *moduleInstance =
    (InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_nyucgZWjM3Ai1CT2jftVoF(SimStruct *S)
{
  InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *moduleInstance =
    (InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_nyucgZWjM3Ai1CT2jftVoF(SimStruct *S)
{
  InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *moduleInstance =
    (InstanceStruct_nyucgZWjM3Ai1CT2jftVoF *)calloc(1, sizeof
    (InstanceStruct_nyucgZWjM3Ai1CT2jftVoF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_nyucgZWjM3Ai1CT2jftVoF);
  ssSetmdlInitializeConditions(S, mdlInitialize_nyucgZWjM3Ai1CT2jftVoF);
  ssSetmdlUpdate(S, mdlUpdate_nyucgZWjM3Ai1CT2jftVoF);
  ssSetmdlTerminate(S, mdlTerminate_nyucgZWjM3Ai1CT2jftVoF);
  ssSetmdlEnable(S, mdlEnable_nyucgZWjM3Ai1CT2jftVoF);
  ssSetmdlDisable(S, mdlDisable_nyucgZWjM3Ai1CT2jftVoF);
...
static void mdlProcessParameters_nyucgZWjM3Ai1CT2jftVoF(SimStruct *S)
{
}

void method_dispatcher_nyucgZWjM3Ai1CT2jftVoF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_nyucgZWjM3Ai1CT2jftVoF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_nyucgZWjM3Ai1CT2jftVoF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_nyucgZWjM3Ai1CT2jftVoF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_nyucgZWjM3Ai1CT2jftVoF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: nyucgZWjM3Ai1CT2jftVoF.\n"
...
mxArray *cgxe_nyucgZWjM3Ai1CT2jftVoF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_nyucgZWjM3Ai1CT2jftVoF_fallback_info(void)
{
