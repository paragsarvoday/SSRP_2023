...
static void cgxe_mdl_start(InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH
...
static void cgxe_mdl_set_sim_state(InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_KfaDhNL7xJVG1u0RUxB9sH(SimStruct *S, int_T tid)
{
  InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *moduleInstance =
    (InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_KfaDhNL7xJVG1u0RUxB9sH(SimStruct *S)
{
  InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *moduleInstance =
    (InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_KfaDhNL7xJVG1u0RUxB9sH(SimStruct *S, int_T tid)
{
  InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *moduleInstance =
    (InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_KfaDhNL7xJVG1u0RUxB9sH(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *moduleInstance =
    (InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *)cgxertGetRuntimeInstance(S);
...
static void setSimState_KfaDhNL7xJVG1u0RUxB9sH(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *moduleInstance =
    (InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_KfaDhNL7xJVG1u0RUxB9sH(SimStruct *S)
{
  InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *moduleInstance =
    (InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_KfaDhNL7xJVG1u0RUxB9sH(SimStruct *S)
{
  InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *moduleInstance =
    (InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_KfaDhNL7xJVG1u0RUxB9sH(SimStruct *S)
{
  InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *moduleInstance =
    (InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_KfaDhNL7xJVG1u0RUxB9sH(SimStruct *S)
{
  InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *moduleInstance =
    (InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH *)calloc(1, sizeof
    (InstanceStruct_KfaDhNL7xJVG1u0RUxB9sH));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_KfaDhNL7xJVG1u0RUxB9sH);
  ssSetmdlInitializeConditions(S, mdlInitialize_KfaDhNL7xJVG1u0RUxB9sH);
  ssSetmdlUpdate(S, mdlUpdate_KfaDhNL7xJVG1u0RUxB9sH);
  ssSetmdlTerminate(S, mdlTerminate_KfaDhNL7xJVG1u0RUxB9sH);
  ssSetmdlEnable(S, mdlEnable_KfaDhNL7xJVG1u0RUxB9sH);
  ssSetmdlDisable(S, mdlDisable_KfaDhNL7xJVG1u0RUxB9sH);
...
static void mdlProcessParameters_KfaDhNL7xJVG1u0RUxB9sH(SimStruct *S)
{
}

void method_dispatcher_KfaDhNL7xJVG1u0RUxB9sH(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_KfaDhNL7xJVG1u0RUxB9sH(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_KfaDhNL7xJVG1u0RUxB9sH(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_KfaDhNL7xJVG1u0RUxB9sH(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_KfaDhNL7xJVG1u0RUxB9sH(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: KfaDhNL7xJVG1u0RUxB9sH.\n"
...
mxArray *cgxe_KfaDhNL7xJVG1u0RUxB9sH_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_KfaDhNL7xJVG1u0RUxB9sH_fallback_info(void)
{
