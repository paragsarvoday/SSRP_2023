...
static emlrtRSInfo emlrtRSI = { 1,     /* lineNo */
  ...
  "C:\\ProgramData\\MATLAB\\SupportPackages\\R2023a\\toolbox\\target\\supportpackages\\android\\+codertarget\\+internal\\androidDat"
  "aDisplay.p"                         /* pathName */
};
...
static emlrtMCInfo b_emlrtMCI = { 1,   /* lineNo */
  1,                                   /* colNo */
  "androidDataDisplay",                /* fName */
  "C:\\ProgramData\\MATLAB\\SupportPackages\\R2023a\\toolbox\\target\\supportpackages\\android\\+codertarget\\+internal\\androidDat"
  "aDisplay.p"                         /* pName */
};

/* Function Declarations */
static void cgxe_mdl_start(InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE
...
static void cgxe_mdl_set_sim_state(InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE
...
static void error(const emlrtStack *sp, const mxArray *m, const mxArray *m1,
                  emlrtMCInfo *location);
static void warning(const emlrtStack *sp, const mxArray *m, emlrtMCInfo
                    *location);
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE
  *moduleInstance);
  ...
  codertarget_internal_androidDataDisplay *obj)
{
  ...
  static char_T d_u[38] = { 'a', 'n', 'd', 'r', 'o', 'i', 'd', ':', 'b', 'u',
    'i', 'l', 'd', ':', 'I', 'n', 'p', 'u', 't', 'E', 'x', 'c', 'e', 'e', 'd',
    's', 'D', 'i', 's', 'p', 'l', 'a', 'y', 'L', 'i', 'm', 'i', 't' };
  ...
  if (obj->isInitialized != 0) {
    ...
    emlrtAssign(&e_y, m);
    st.site = &d_emlrtRSI;
    error(&st, y, getString(&st, message(&st, d_y, e_y, &emlrtMCI), &emlrtMCI),
          &emlrtMCI);
  }
  ...
  emlrtAssign(&b_y, m);
  c_y = NULL;
  m = emlrtCreateDoubleScalar(80.0);
  emlrtAssign(&c_y, m);
  b_st.site = &emlrtRSI;
  warning(&b_st, message(&b_st, b_y, c_y, &b_emlrtMCI), &b_emlrtMCI);
}
                    ...
                    *location)
{
  const mxArray *pArray;
  pArray = m;
  emlrtCallMATLABR2012b((emlrtConstCTX)sp, 0, NULL, 1, &pArray, "warning", true,
                        location);
}
  ...
  *moduleInstance)
{
  moduleInstance->emlrtRootTLSGlobal = (void *)cgxertGetEMLRTCtx
    (moduleInstance->S);
  moduleInstance->u0 = (uint8_T (*)[255])cgxertGetInputPortSignal
    (moduleInstance->S, 0);
}

/* CGXE Glue Code */
static void mdlOutputs_5xTZ4YsU7u7BGsF2q9qRzE(SimStruct *S, int_T tid)
{
  InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *moduleInstance =
    (InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_5xTZ4YsU7u7BGsF2q9qRzE(SimStruct *S)
{
  InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *moduleInstance =
    (InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_5xTZ4YsU7u7BGsF2q9qRzE(SimStruct *S, int_T tid)
{
  InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *moduleInstance =
    (InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_5xTZ4YsU7u7BGsF2q9qRzE(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *moduleInstance =
    (InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *)cgxertGetRuntimeInstance(S);
...
static void setSimState_5xTZ4YsU7u7BGsF2q9qRzE(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *moduleInstance =
    (InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_5xTZ4YsU7u7BGsF2q9qRzE(SimStruct *S)
{
  InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *moduleInstance =
    (InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_5xTZ4YsU7u7BGsF2q9qRzE(SimStruct *S)
{
  InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *moduleInstance =
    (InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_5xTZ4YsU7u7BGsF2q9qRzE(SimStruct *S)
{
  InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *moduleInstance =
    (InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_5xTZ4YsU7u7BGsF2q9qRzE(SimStruct *S)
{
  InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *moduleInstance =
    (InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE *)calloc(1, sizeof
    (InstanceStruct_5xTZ4YsU7u7BGsF2q9qRzE));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_5xTZ4YsU7u7BGsF2q9qRzE);
  ssSetmdlInitializeConditions(S, mdlInitialize_5xTZ4YsU7u7BGsF2q9qRzE);
  ssSetmdlUpdate(S, mdlUpdate_5xTZ4YsU7u7BGsF2q9qRzE);
  ssSetmdlTerminate(S, mdlTerminate_5xTZ4YsU7u7BGsF2q9qRzE);
  ssSetmdlEnable(S, mdlEnable_5xTZ4YsU7u7BGsF2q9qRzE);
  ssSetmdlDisable(S, mdlDisable_5xTZ4YsU7u7BGsF2q9qRzE);
...
static void mdlProcessParameters_5xTZ4YsU7u7BGsF2q9qRzE(SimStruct *S)
{
}

void method_dispatcher_5xTZ4YsU7u7BGsF2q9qRzE(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_5xTZ4YsU7u7BGsF2q9qRzE(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_5xTZ4YsU7u7BGsF2q9qRzE(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_5xTZ4YsU7u7BGsF2q9qRzE(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_5xTZ4YsU7u7BGsF2q9qRzE(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 5xTZ4YsU7u7BGsF2q9qRzE.\n"
...
mxArray *cgxe_5xTZ4YsU7u7BGsF2q9qRzE_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_5xTZ4YsU7u7BGsF2q9qRzE_fallback_info(void)
{
