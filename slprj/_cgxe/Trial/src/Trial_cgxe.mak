...
MODEL  = Trial
TARGET = cgxe
MODULE_SRCS 	= m_DH3jGOJ4u96z2aK3hkI3OE.c m_yXjhySGjxhbOwMeUG2qaED.c m_UOPiPZ4gyGXLET3FdL2udC.c m_DYUjf4SydzIrcGQMWETqVE.c
MODEL_SRC	= Trial_cgxe.c
MODEL_REG = Trial_cgxe_registry.c
MAKEFILE    = Trial_cgxe.mak
...
USER_INCLUDES   =  /I "C:\different\matlab_app\slprj\_cgxe\Trial\src" /I "C:\different\matlab_app" /I "C:\Different\Matlab_App\slprj\_cprj"
...
THIRD_PARTY_INCLUDES   =  /I "C:\Different\Matlab_App\slprj\_cgxe\Trial\src" /I "C:\Different\Matlab_App"
