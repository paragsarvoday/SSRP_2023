...
static void cgxe_mdl_start(InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_UOPiPZ4gyGXLET3FdL2udC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_UOPiPZ4gyGXLET3FdL2udC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_UOPiPZ4gyGXLET3FdL2udC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_UOPiPZ4gyGXLET3FdL2udC
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_UOPiPZ4gyGXLET3FdL2udC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_UOPiPZ4gyGXLET3FdL2udC
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_UOPiPZ4gyGXLET3FdL2udC
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_UOPiPZ4gyGXLET3FdL2udC
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_UOPiPZ4gyGXLET3FdL2udC
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_UOPiPZ4gyGXLET3FdL2udC
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_UOPiPZ4gyGXLET3FdL2udC
...
static void cgxe_mdl_set_sim_state(InstanceStruct_UOPiPZ4gyGXLET3FdL2udC
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_UOPiPZ4gyGXLET3FdL2udC
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_UOPiPZ4gyGXLET3FdL2udC(SimStruct *S, int_T tid)
{
  InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *moduleInstance =
    (InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_UOPiPZ4gyGXLET3FdL2udC(SimStruct *S)
{
  InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *moduleInstance =
    (InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_UOPiPZ4gyGXLET3FdL2udC(SimStruct *S, int_T tid)
{
  InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *moduleInstance =
    (InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_UOPiPZ4gyGXLET3FdL2udC(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *moduleInstance =
    (InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *)cgxertGetRuntimeInstance(S);
...
static void setSimState_UOPiPZ4gyGXLET3FdL2udC(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *moduleInstance =
    (InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_UOPiPZ4gyGXLET3FdL2udC(SimStruct *S)
{
  InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *moduleInstance =
    (InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_UOPiPZ4gyGXLET3FdL2udC(SimStruct *S)
{
  InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *moduleInstance =
    (InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_UOPiPZ4gyGXLET3FdL2udC(SimStruct *S)
{
  InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *moduleInstance =
    (InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_UOPiPZ4gyGXLET3FdL2udC(SimStruct *S)
{
  InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *moduleInstance =
    (InstanceStruct_UOPiPZ4gyGXLET3FdL2udC *)calloc(1, sizeof
    (InstanceStruct_UOPiPZ4gyGXLET3FdL2udC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_UOPiPZ4gyGXLET3FdL2udC);
  ssSetmdlInitializeConditions(S, mdlInitialize_UOPiPZ4gyGXLET3FdL2udC);
  ssSetmdlUpdate(S, mdlUpdate_UOPiPZ4gyGXLET3FdL2udC);
  ssSetmdlTerminate(S, mdlTerminate_UOPiPZ4gyGXLET3FdL2udC);
  ssSetmdlEnable(S, mdlEnable_UOPiPZ4gyGXLET3FdL2udC);
  ssSetmdlDisable(S, mdlDisable_UOPiPZ4gyGXLET3FdL2udC);
...
static void mdlProcessParameters_UOPiPZ4gyGXLET3FdL2udC(SimStruct *S)
{
}

void method_dispatcher_UOPiPZ4gyGXLET3FdL2udC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_UOPiPZ4gyGXLET3FdL2udC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_UOPiPZ4gyGXLET3FdL2udC(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_UOPiPZ4gyGXLET3FdL2udC(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_UOPiPZ4gyGXLET3FdL2udC(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: UOPiPZ4gyGXLET3FdL2udC.\n"
...
mxArray *cgxe_UOPiPZ4gyGXLET3FdL2udC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_UOPiPZ4gyGXLET3FdL2udC_fallback_info(void)
{
